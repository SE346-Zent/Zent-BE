...
fn map_work_order_detail(model: work_order::Model) -> WorkOrderDetailResponseData {
...
fn map_work_order_list_item(model: work_order::Model) -> WorkOrderListItemResponseData {
