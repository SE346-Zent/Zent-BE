...
#[openapi(
    paths(
        ...
        inventory::list_parts::list_parts,
        inventory::get_part::get_part,
        inventory::list_products::list_products,
        inventory::get_product::get_product,
        inventory::check_serial::check_serial,
        inventory::check_warranty::check_warranty,
        inventory::register_product::register_product,
    ...
    components(
        schemas(
            ...
            crate::model::responses::inventory::part_list_item::PartListItem,
            crate::model::responses::inventory::part_detail_response::PartDetailResponse,
            crate::model::responses::inventory::product_list_item::ProductListItem,
            crate::model::responses::inventory::product_detail_response::ProductDetailResponse,
            crate::model::requests::inventory::check_serial_request::CheckSerialRequest,
            ...
            crate::model::requests::inventory::register_product_request::RegisterProductRequest,
            crate::model::responses::inventory::register_product_response::RegisterProductResponse,
