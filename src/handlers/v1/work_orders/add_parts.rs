...
use crate::model::requests::work_orders::add_parts_request::AddPartsRequest;
use crate::model::responses::base::ApiResponse;
use crate::entities::work_orders as work_orders_ent;

#[utoipa::path(
    post, path = "/api/v1/work_orders/{id}/parts", request_body = AddPartsRequest,
    responses(
...
pub async fn add_parts(
    ...
    let effect = crate::services::v1::work_orders::add_parts::decide_add_parts(payload, wo, auth.user.id)?;
