...
) -> Result<Json<ApiResponse<Vec<NotificationPreferenceResponse>>>, AppError> { unimplemented!() }

/// PUT /api/v1/notifications/preferences
pub async fn update_preferences(
    Json(_body): Json<UpdateNotificationPreferenceRequest>,
) -> Result<Json<ApiResponse<()>>, AppError> { unimplemented!() }

/// GET /api/v1/notifications
pub async fn list(
    axum::extract::Query(_query): axum::extract::Query<NotificationListQuery>,
) -> Result<Json<ApiResponse<Vec<NotificationListItem>>>, AppError> { unimplemented!() }

/// GET /api/v1/notifications/{id}
pub async fn get_detail(
    Path(_id): Path<Uuid>,
) -> Result<Json<ApiResponse<NotificationDetailResponse>>, AppError> { unimplemented!() }
...
) -> Result<Json<ApiResponse<Vec<NotificationCategoryResponse>>>, AppError> { unimplemented!() }
