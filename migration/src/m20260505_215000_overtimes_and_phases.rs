...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        // Rename work_order_image_links to work_order_closing_image_links
        manager
            .rename_table(
                Table::rename()
        ...
        manager
            .alter_table(
                Table::alter()
                    ...
                    .add_column(ColumnDef::new(WorkOrderClosingImageLinks::Phase).string().not_null().default("general"))
                    .to_owned(),
            )
            .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .alter_table(
                Table::alter()
                    .table(WorkOrderClosingImageLinks::Table)
                    .drop_column(WorkOrderClosingImageLinks::Phase)
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .drop_table(Table::drop().table(Overtimes::Table).to_owned())
            .await?;
